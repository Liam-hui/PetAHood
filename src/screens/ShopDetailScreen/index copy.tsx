      ...
      {data && <>
        ...
        >
          ...
          <View style={{ paddingHorizontal: Layout.page.paddingHorizontal, backgroundColor: "white", paddingTop: 10, borderBottomRightRadius: 27, borderBottomLeftRadius: 27, ...Styles.shadowStyle }}>
            ...
            <Sep/>
            {/* chain stores */}
            <TouchableOpacity style={{ alignSelf: "center", marginVertical: 10, flexDirection: "row", alignItems: "center" }}>
                ...
                ? <HideAndShow
                    ...
                    shownElement={
                      <View style={{ width: "100%" }}>
                        <Sep/>
                        <View style={{ alignSelf: "center", marginTop: 10, marginBottom: 15, flexDirection: "row", alignItems: "center" }}>
                          <Text style={{ color: Colors.darkOrange }}>{t(isReviewsShown ? "shopDetails_lessReviews" : "shopDetails_moreReviews")}</Text>
                          <Icon size={12} icon={require("@/assets/icons/icon-downArrowOrange.png")} style={{ marginLeft: 5, transform: [{ rotateZ: isReviewsShown ? "180deg" : "-90deg" }] }} />
                        </View>
                      </View>
                    }
                    onShow={() => setIsReviewsShown(true)}
                    onHide={() => setIsReviewsShown(false)}
                  >
